          ...
          {day.lectures.map((lecture, lectureIndex) => (
            <div key={lectureIndex} className="flex gap-2 items-center mb-3">
              <input
                ...
                onChange={(e) => handleLectureChange(dayIndex, lectureIndex, "start_time", e.target.value)}
              />
              <input
                type="time"
                className="p-2 border rounded-lg w-1/6"
                value={lecture.end_time}
                onChange={(e) => handleLectureChange(dayIndex, lectureIndex, "end_time", e.target.value)}
              />
